...
fun main() {
    ...
    val processor1 = PaymentProcessor(CreditCardPayment())
    val processor2 = PaymentProcessor(PayPalPayment())
    val processor3 = PaymentProcessor(BitcoinPayment())

    processor1.processOrderPayment(order1.totalAmount)
    processor2.processOrderPayment(order2.totalAmount)
    processor3.processOrderPayment(order3.totalAmount)
}
